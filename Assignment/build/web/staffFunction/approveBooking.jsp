<%-- 
    ...
    Created on : 2023年3月31日, 下午12:16:30
    Author     : henry
--%>
...
<html>
	...
	out.println("<th>BookingRequestId</th><th>bookDate</th><th>bookVenueId</th><th>bookMemberId</th><th>bookStartTime</th><th>BookEndTime</th><th>BookingStatus</th>"
                + "<th>BookRequestTime</th><th>BookPaymentReceipt</th><th>BookGuestListId</th><th>CheckInTIme</th><th>CheckOutTIme</th>"); 
	out.println("</tr>"); 
	...
	out.println("<tr>"); 
        ...
        out.println("<td><a href='/Assignment/BookRequestController?action=approve&bookingRequestId="+  c.getBookingRequestId() + "'>Approve</a></td>");
        ...
        out.println("<td><a href='#' onclick=\"if (confirm(\'Are you sure you want to reject booking?"+ "ID : "+ c.getBookingRequestId()
                + "\')) {window.location.href="
                        + "\'/Assignment/BookRequestController?action=reject&bookingRequestId="+ c.getBookingRequestId() + "\'"
                        + ";};\">Reject</a></td>");
	out.println("</tr>"); } 
        out.println("</table>");
        %>
